...
void man(char *name)
{
    ...
    {
        printf("Desciption : Used tp create new regular file \n");
    ...
    else if(strcmp(name,"write") == 0)
    {
        ...
        printf("Usage : write File_name\n Afyer this enter the data that we want to write\n");
    }
    ...
    {
        printf("Description : Used to open all opened file\n");
    ...
    {
        printf("Description : Used to cloase all opened files\n");
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information of the file using name\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating the Marvellous Virutal File System\n");
                break;
            }
            else
            {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0], "create") == 0)
            {
                ...
                if(ret == -1)
                    printf("ERROR : Inocrrect parameters\n");
                if(ret == -2)
                    printf("ERROR : There is no inodes\n");
                if(ret == -3)
                    printf("ERROR : File already exists\n");
                if(ret == -4)
                    printf("ERROR : Memory allocation failute\n");
                continue;
            }
            ...
            else if(strcmp(command[0], "read") == 0)
            {
                ...
                if(fd == -1)
                {
                    printf("Error : Incorrect paramaeter\n");
                    continue;
                }
                ptr = (char *)malloc(sizeof(atoi(command[2])) + 1);
                if(ptr == NULL)
                {
                    printf("ERROR : Mmemory allocation failute\n");
                    continue;
                }
                ret = ReadFile(fd, ptr, atoi(command[2]));
                if(ret == -1)
                    printf("ERROR : File not existiing\n");
                if(ret == -2)
